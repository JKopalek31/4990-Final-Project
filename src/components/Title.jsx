...
export const Title = () => {
  ...
  return (
    <div className="grid grid-cols-[1fr_auto_1fr] gap-6 px-8 py-8 bg-offwhite text-slate-800 shadow-lg">
  {/* Left: Image */}
      <motion.div
        ref={headingRef}
      ...
      {/* Middle: Smaller Vertical Bar */}
      <div className="flex justify-center items-center">
        <motion.div
          className="w-1 h-72 bg-maroon rounded-full"
      ...
      <div className="bg-offwhite rounded-lg px-4 py-4">
        ...
        <p className="text-lg text-slate-800 font-semibold mb-3">This project aims to research:</p>
